...
interface ExpandMorePropss extends IconButtonProps {
  expand: boolean;
}

const ExpandMores = styled((props: ExpandMorePropss) => {
  const { expand, ...other } = props;
  return <IconButton {...other} />;
})(({ theme, expand }) => ({
  transform: !expand ? 'rotate(0deg)' : 'rotate(180deg)',
...
interface ExpandMorePropss3 extends IconButtonProps {
  expand: boolean;
}

const ExpandMores3 = styled((props: ExpandMorePropss3) => {
  const { expand, ...other } = props;
  return <IconButton {...other} />;
})(({ theme, expand }) => ({
  transform: !expand ? 'rotate(0deg)' : 'rotate(180deg)',
...
interface ExpandMorePropss4 extends IconButtonProps {
  expand: boolean;
}

const ExpandMores4 = styled((props: ExpandMorePropss4) => {
  const { expand, ...other } = props;
  return <IconButton {...other} />;
})(({ theme, expand }) => ({
  transform: !expand ? 'rotate(0deg)' : 'rotate(180deg)',
